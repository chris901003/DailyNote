...
protocol BPPPhotoListCellDelegate: AnyObject {
    func deleteImageAction(cell: BPPPhotoListCell)
}

class BPPPhotoListCell: UICollectionViewCell {
    static let cellId = "BPPPhotoListCellId"

    let imageView = UIImageView()
    let deleteButton = UILabel()

    weak var delegate: BPPPhotoListCellDelegate?
